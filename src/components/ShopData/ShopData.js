...
export const shoes = [
  {
    ...
    suggestionImg: {
      view_1: images.imgView_1_1,
      view_2: images.imgView_1_2,
      view_3: images.imgView_1_3,
      view_4: images.imgView_1_4,
      view_5: images.imgView_1_5,
      hoverImg_1: images.imgHover_1_1,
      hoverImg_2: images.imgHover_1_2,
      hoverImg_3: images.imgHover_1_3,
      hoverImg_4: images.imgHover_1_4,
      hoverImg_5: images.imgHover_1_5,
    },
    suggestionInfo: {
      first: "Charleton south carolina script large tote bag",
      second: "Pamela Star Sneakers",
      third: "Charleston South Carolina Pullover",
      fourth: "Charleston South Carolina Pullover",
      fifth: "Serena High Top Star Sneakers",
    },
    suggestionPrice: {
      first: 16.00,
      second: 78.00,
